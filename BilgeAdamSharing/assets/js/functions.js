...
(function($){
   "use strict";
	...
	$.ajax({
		url:'demo/demo_option.js',
		type:'HEAD',
		error: function(){},
		success: function()
		{
			$('head').append( $('<link rel="stylesheet" type="text/css" />').attr('href', 'demo/demo-style.css') );
		    $('head').append( $('<script type="text/javascript"></script>').attr('src', 'demo/demo_option.js') );
		}
	});
	//----------> Site Preloader	
