<%@ Page Language="C#" AutoEventWireup="true" CodeBehind=".cs" Inherits="BilgeAdamSharing.Default" %>
...
<body runat="server" class="preloader2 dark_sup_menu light_header">
	...
	<div id="main_wrapper">
		...
		<div class="content row_spacer centered clearfix">
			...
			<Triggers>
				<asp:AsyncPostBackTrigger ControlID="ButtonGirisYap" EventName="Click" />
			</Triggers>
		</asp:UpdatePanel>     
		</form>
	</div>
	...
	<script type="text/javascript">
		function Hata() {
			alertify.log('<strong>Kullanıcı Adı veya Şifreniz Hatalı.</strong>', 'error');
		}
		function Blocked() {
			alertify.log('<strong>Bu kullanıcı AKTİF değildir.</strong>', 'error');
		}
	</script>
</body>
</html>
